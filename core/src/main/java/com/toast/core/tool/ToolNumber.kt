...
package com.toast.core.tool

/**
 * desc: 数字工具类 <br/>
 * time: 2020/11/15 20:04 <br/>
 * author: Toast <br/>
 * since: V 1.0 <br/>
 */
...
/**
 * 强转成double基本类型值，不截取、不会四舍五入，默认0.0 (譬如：数据类型不匹配、转换异常)
</br>
 * 可能存在(1.0/3 = 0.333333333333333)未截取情况，使用 [.toDouble] 可处理。
</br>
 *
 *
 * 示例：
</br>
 * null、""、1.1abc、ab2.2、１２３４(全角) -> 0.0
</br>
 * 55.66、"55.66" -> 55.66
</br>
 * -5.4999、"-5.4999" -> -5.4999
</br>
 *
 * @param doubleValue 浮点值
 * @return 转换后的浮点值
